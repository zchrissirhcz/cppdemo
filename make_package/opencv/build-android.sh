...
install_dir="$ZZPKG_ROOT/opencv/$tag/android-arm64"
...
CMAKE_OPTIONS+=(
    ...
    -DOPENCV_3P_LIB_INSTALL_PATH="libs"
...
cmake -DCMAKE_TOOLCHAIN_FILE="$ANDROID_NDK/build/cmake/android.toolchain.cmake" \
      ...
      -S opencv -B "$build_dir" -G Ninja -Wno-deprecated
