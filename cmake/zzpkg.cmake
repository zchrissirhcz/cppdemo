...
macro(zzpkg_find PACKAGE_RECIPE)
  ...
  if(NOT EXISTS ${PACKAGE_PLATFORM_INDEPENDENT_ROOT})
    message(FATAL_ERROR "PACKAGE_PLATFORM_INDEPENDENT_ROOT(${PACKAGE_PLATFORM_INDEPENDENT_ROOT}) does not exist for recipe: ${PACKAGE_RECIPE}")
  endif()
